<?php
        ...
        if(isset($_POST['submit']))
        {
            ...
            //   $b=$_POST['b'];
              $c=$_POST['c'];
              $sql="UPDATE `withdrawal` SET `amount`=`amount`-'$c' WHERE phone='$id'";
              $rs=mysqli_query($con,$sql);
              if($rs)
                  {
                      ?>
                    ...
                    <div class="row">
                      <div class="col-lg-6 mx-auto">
                        <div class="auth-form-light text-left p-5">
                            <!--value="<?php echo $r; ?>"-->
                          <h6 class="font-weight-light">Update Wallet Details</h6>
                          <form class="pt-3" Method="POST">
                            <div class="form-group">
                              <!--<h5>User ID</h5>-->
                              <!--<input type="text" class="form-control form-control-lg" value="<?php echo $row['id']?>" name="a" required=""><br>-->
                              <h5>User Mobile No.</h5>
                              <input type="text" class="form-control form-control-lg" value="<?php echo $id;?>" readonly name="b" required="" ><br>
