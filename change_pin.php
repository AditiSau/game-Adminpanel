<?php
        ...
        if(isset($_POST['submit']))
        {
             ...
             // $d=$_POST['d'];
            //   $e=$_POST['e'];
              $sql="UPDATE `register` SET `mpin`='$b' WHERE email='$email'";
              $rs=mysqli_query($con,$sql);
              if($rs)
                  {
                      ?>
                        <script>
                            alert("Security Pin Update SuccessFull");
                        </script>
                      <?php
                  }
                  else
      ...
      <div class="col-sm-12">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
					...
					<div class="card-body">
						<h4 class="card-title">Change Security Pin</h4>
						<form class="theme-form mega-form" id="adminUPIFrm" name="adminUPIFrm" method="post">
							...
							<div class="row">
								<div class="form-group col-12">
									<label class="col-form-label">Security Pin</label>
									<input class="form-control" type="text" name="b" id="google_upi_payment_id" value="<?php echo $row['mpin'];?>" placeholder="Enter New Security Pin">
								</div>
							</div>
							...
							<div class="form-group">
								<input type="submit" class="btn btn-primary waves-light m-t-10" id="upiSubmitBtn" name="submit" onClick="return confirm('Do you really want to Update Security Pin??');" value="Update">
							</div>
							<div class="form-group">
