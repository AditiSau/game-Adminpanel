<?php
        ...
        if(isset($_POST['submit']))
        {
              ...
              $d=$_POST['d'];
            //   $e=$_POST['e'];
              $sql="UPDATE `admin_login` SET `g_pay_id`='$b',`phone_pay_id`='$c',`other_pay_id`='$d' WHERE email='$a'";
              $rs=mysqli_query($con,$sql);
              if($rs)
                  {
                      ?>
                        <script>
                            alert("Admin UPI Details Update SuccessFull");
                        </script>
                      <?php
                  }
                  else
      ...
      <div class="col-sm-12">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
					...
					<div class="card-body">
						<h4 class="card-title">Change UPI ID</h4>
						<form class="theme-form mega-form" id="adminUPIFrm" name="adminUPIFrm" method="post">
							...
							<div class="row">
								<div class="form-group col-12">
									...
									<input class="form-control" type="text" name="b" id="google_upi_payment_id" value="<?php echo $row['g_pay_id'];?>" placeholder="Enter google upi payment id">
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group col-12">
									...
									<input class="form-control" type="text" name="c" id="phonepay_upi_payment_id" value="<?php echo $row['phone_pay_id'];?>" placeholder="Enter phonepay upi payment id">
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group col-12">
									...
									<input class="form-control" type="text" name="d" id="upi_payment_id" value="<?php echo $row['other_pay_id'];?>" placeholder="Enter upi payment id">
								</div>
							</div>
							
							<div class="form-group">
								<input type="submit" class="btn btn-primary waves-light m-t-10" id="upiSubmitBtn" name="submit" onClick="return confirm('Do you really want to Update Admin UPI Details??');" value="Update">
							</div>
							<div class="form-group">
