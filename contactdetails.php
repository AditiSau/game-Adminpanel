	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-12">
				<div class="card">
					<div class="card-body">
						<h4 class="card-title d-flex align-items-center justify-content-between">Contact List</h4>
						<div id="userQueryList_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
							
								<!--<div class="dataTables_length" id="userQueryList_length">                                                                   <label>Show <select name="userQueryList_length" aria-controls="userQueryList" class="custom-select custom-select-sm form-control form-control-sm">                                                                   <option value="10">10</option>                                                                   <option value="25">25</option>                                                                   <option value="50">50</option>                                                                   <option value="100">100</option>                                                                   </select> entries</label>                                                                   </div>                                                                   </div>                                                                   <div class="col-sm-12 col-md-6">                                                                   <div id="userQueryList_filter" class="dataTables_filter">                                                                   <label>Search:<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="userQueryList">                                                                   </label>                                                                   </div>                                                                   </div>                                                                   </div>      -->
					    ...
					    <tr class="odd">
					        ...
					        <td align="center">                                                                   <?php echo $cnt;?>                                                                   </td>
                                  ...
                                  <td align="center">                                                                   <?php echo $row['m_date'];?>                                                                   </td>
                                  <td align="center"> <a href="deletequery3.php?id=<?php echo $row['phone'];?>"
