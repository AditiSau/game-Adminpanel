<?php
 ...
 include 'files/dbcon.php';
  ...
  if(isset($_POST['submit'])){
   ...
   $updatequery="UPDATE `game_list` SET `a_time`='$b',`c_time`='$c',`game_status`='OFF',`day`='$d' WHERE game_id='$id'";
  ...
  if($query)
  {
      ?>
        <script>
            alert("Game Deactivate SuccessFull");
        </script>
      <?php
  }
  else
  {
      ?>
        <script>
            alert("Game Deactivate UnsuccessFull");
        </script>
      <?php
  }
						...
						<form class="theme-form mega-form" id="adminUPIFrm" name="adminUPIFrm" method="post">
							...
							<div class="row">
								<div class="form-group col-12">
									<label class="col-form-label">Deactive Game</label>
